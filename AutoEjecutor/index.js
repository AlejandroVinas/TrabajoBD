...
const datosstock = [
    ...
    { ID: 4, Nombre: 'Dredge', stock: 8, Genero: 'Pesca', Desarrollador: 'Black Salt Games', Precio: 5},
    { ID: 2, Nombre: 'Whos Lila', stock: 50, Genero: 'Surrealismo', Desarrollador: 'Garage Heathen', Precio: 10},
    { ID: 3, Nombre: 'Cruelty Squad', stock: 27, Genero: 'Sátira', Desarrollador: 'Consumer Softproducts', Precio: 15},
